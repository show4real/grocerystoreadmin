...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    InputTag: (vue_input_tag__WEBPACK_IMPORTED_MODULE_0___default()),
  ...
  methods: {
      ...
      if (this.id && variant_id !== "") {
        this.$swal.fire({
          ...
          if (result.value) {
            ...
            axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this.$apiUrl + '/products/delete', postData).then(function (response) {
              var data = response.data;

              _this.inputs.splice(index, 1);
    ...
    otherImage: function otherImage() {
      ...
      for (var i = 0; i < this.$refs.file_other_images.files.length; i++) {
        var image = {};
        var file = this.$refs.file_other_images.files[i];
    ...
    variantImagesChanges: function variantImagesChanges(index) {
      //this.variantImages = {};
      var tempImages = [];
      Vue.set(this.variantImages, index, []); //console.log("this.variantImages => ",this.variantImages);
      ...
      if (this.type === 'packet') {
        for (var i = 0; i < this.$refs['packet_variant_images_' + index][0].files.length; i++) {
          ...
          image.url = URL.createObjectURL(file);
          image.name = file.name; //this.variantImages[index].push(image);

          tempImages.push(image); //this.variantImages[index] = tempImages;
        ...
        for (var i = 0; i < this.$refs['loose_variant_images_' + index][0].files.length; i++) {
          ...
          _image.name = _file.name; //this.variantImages[index].push(image);
    ...
    getSellerCategories: function getSellerCategories() {
      ...
      if (this.seller_id !== 0 && this.seller_id !== "") {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/categories/seller_categories', {
          params: param
        }).then(function (response) {
          _this2.isLoading = false;
          var data = response.data; //this.categories = data.data

          _this2.categoryOptions = "<option value=\"\">--Select Category--</option>" + data; //console.log("categories : ", this.categoryOptions);
        });
      }
    },
    ...
    getSellers: function getSellers() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/sellers').then(function (response) {
        ...
        var data = response.data;
        _this4.sellers = data.data; //console.log("sellers : ", this.sellers);
      });
    },
    getTaxes: function getTaxes() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/taxes').then(function (response) {
        ...
        var data = response.data;
        _this5.taxes = data.data; //console.log("taxes : ", this.taxes);
      });
    },
    getUnits: function getUnits() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/units/get').then(function (response) {
        ...
        var data = response.data;
        _this6.units = data.data; //console.log("units : ", this.units);
      });
    },
    getBrands: function getBrands() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/brands/get').then(function (response) {
        ...
        var data = response.data;
        _this7.brands = data.data; // console.log("brands : ", this.brands);
      });
    },
    getCountries: function getCountries() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/countries').then(function (response) {
        ...
        var data = response.data;
        _this8.countries = data.data; //console.log("countries : ", this.countries);
      });
    },
    getOrderStatus: function getOrderStatus() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/order_statuses').then(function (response) {
        ...
        var data = response.data;
        _this9.order_status = data.data; //console.log("order_status =>",this.order_status);
      });
    },
    getProduct: function getProduct() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/edit/' + this.id).then(function (response) {
        ...
        if (data.status === 1) {
          var _this10$record$indica;

          //console.log("data=>",response.data);
          _this10.record = data.data; //Fill Data

          _this10.name = _this10.record.name;
          _this10.slug = _this10.record.slug;
          _this10.seller_id = _this10.record.seller_id;

          _this10.getSellerCategories();

          if (_this10.record.tags) {
            _this10.tags = _this10.record.tags.split(",");
          }

          _this10.tax_id = _this10.record.tax_id;
          _this10.brand = _this10.brands.find(function (item) {
            return item.id === _this10.record.brand_id;
          });
          _this10.type = _this10.record.type;
          _this10.category_id = _this10.record.category_id;
          _this10.product_type = (_this10$record$indica = _this10.record.indicator) !== null && _this10$record$indica !== void 0 ? _this10$record$indica : "";
          _this10.manufacturer = _this10.record.manufacturer;
          _this10.made_in = _this10.countries.find(function (item) {
            return item.id == _this10.record.made_in;
          });
          _this10.tax_included_in_price = _this10.record.tax_included_in_price;
          _this10.return_status = _this10.record.return_status;
          _this10.return_days = _this10.record.return_days;
          _this10.cancelable_status = _this10.record.cancelable_status;
          _this10.till_status = _this10.record.till_status;
          _this10.cod_allowed_status = _this10.record.cod_allowed;
          _this10.max_allowed_quantity = _this10.record.total_allowed_quantity;
          _this10.description = _this10.record.description;
          _this10.is_approved = _this10.record.is_approved;
          _this10.status = _this10.record.status;
          _this10.is_unlimited_stock = _this10.record.is_unlimited_stock;
          _this10.main_image_path = _this10.$storageUrl + _this10.record.image;
          _this10.other_images = _this10.record.images;
          var vm = _this10;

          if (_this10.type == 'packet') {
            _this10.inputs = [];

            _this10.record.variants.forEach(function (item) {
              var variantData = {
                'id': item.id ? item.id : "",
          ...
          if (_this10.type == 'loose') {
            ...
            _this10.loose_stock = loose_stock;
    ...
    saveRecord: function saveRecord() {
      ...
      formData.append('image', this.image); // Other Images
    ...
    deleteImage: function deleteImage(index, id, productImage) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          _this12.deleteImageIds.push(id);

          if (productImage) {
            _this12.other_images.splice(index, 1);
          } else {
            if (_this12.type === 'packet') {
              _this12.inputs[key].images.splice(index, 1);
            } else {
              _this12.inputs[key].loose_images.splice(index, 1);
            }
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditProduct_vue_vue_type_style_index_0_id_a901b314_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditProduct_vue_vue_type_style_index_0_id_a901b314_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _EditProduct_vue_vue_type_template_id_a901b314_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EditProduct.vue?vue&type=template&id=a901b314&scoped=true& */ "./resources/js/views/Product/EditProduct.vue?vue&type=template&id=a901b314&scoped=true&");
/* harmony import */ var _EditProduct_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EditProduct.vue?vue&type=script&lang=js& */ "./resources/js/views/Product/EditProduct.vue?vue&type=script&lang=js&");
/* harmony import */ var _EditProduct_vue_vue_type_style_index_0_id_a901b314_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css& */ "./resources/js/views/Product/EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _EditProduct_vue_vue_type_template_id_a901b314_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _EditProduct_vue_vue_type_template_id_a901b314_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "a901b314",
  null
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditProduct_vue_vue_type_style_index_0_id_a901b314_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=style&index=0&id=a901b314&scoped=true&lang=css&");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditProduct_vue_vue_type_template_id_a901b314_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditProduct_vue_vue_type_template_id_a901b314_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditProduct_vue_vue_type_template_id_a901b314_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditProduct.vue?vue&type=template&id=a901b314&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=template&id=a901b314&scoped=true&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=template&id=a901b314&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/EditProduct.vue?vue&type=template&id=a901b314&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    _c("div", { staticClass: "page-heading" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-12 col-md-6 order-md-1 order-last" }, [
          _c("h3", [_vm._v(_vm._s(_vm.__("add_product")))]),
        ]),
        _vm._v(" "),
            ...
            [
              _c("ol", { staticClass: "breadcrumb" }, [
                ...
                _c(
                  ...
                  [
                    _c("router-link", { attrs: { to: "/manage_products" } }, [
                ...
                _c("div", { staticClass: "card-body" }, [
                  ...
                  _c("div", { staticClass: "divider" }, [
                    _c("div", { staticClass: "divider-text" }, [
                      _vm._v(_vm._s(_vm.__("add_product_form"))),
                    ]),
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      this.$roleSeller == _vm.login_user.role.name
                        ? [
                            _c("input", {
                              directives: [
                                {
                      ...
                      _c("div", { staticClass: "col-md-6" }, [
                        _c(
                          ...
                          { staticClass: "form-group" },
                          [
                            _c("label", [_vm._v(_vm._s(_vm.__("brands")))]),
                            _vm._v(" "),
                            _c("multiselect", {
                              attrs: {
                                options: _vm.brands,
                      ...
                      _c("div", { staticClass: "col-md-6" }, [
                        _c("div", { staticClass: "form-group" }, [
                          _c("label", { attrs: { for: "other_images" } }, [
                            _vm._v(
                              _vm._s(_vm.__("other_images_of_the_product"))
                            ),
                          ]),
                          _vm._v(" "),
                          _c("input", {
                ...
                _c(
                  ...
                  [
                    ...
                    _vm._l(_vm.inputs, function (input, k) {
                      return _vm.type === "packet"
                        ? _c(
                            "div",
                            {
                              key: k,
                              staticClass: "list-group-item",
                              attrs: { id: "packate_div" },
                            },
                            [
                              _c("div", { staticClass: "row" }, [
                                _c("div", { staticClass: "col-md-4" }, [
                                        ...
                                        directives: [
                                          {
                                            name: "model",
                                            rawName: "v-model",
                                            value: input.packet_stock_unit_id,
                                            expression:
                                              "input.packet_stock_unit_id",
                                          },
                                        ],
                                        staticClass: "form-control form-select",
                                        on: {
                                ...
                                k === 0
                                  ? _c(
                                      ...
                                      {
                                        staticClass:
                                          "col-md-2 offset-md-10 text-end",
                                      },
                                      [
                                        _c(
                                          "a",
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: input.loose_measurement,
                                              expression:
                                                "input.loose_measurement",
                                            },
                                          ],
                                          staticClass: "form-control",
                                          attrs: {
                  ...
                  _c("div", { staticClass: "row" }, [
                    ...
                    _c("div", { staticClass: "col-md-6" }, [
                      _c(
                        ...
                        { staticClass: "form-group" },
                        [
                          _c("label", [_vm._v(_vm._s(_vm.__("made_in")))]),
                          _vm._v(" "),
                          _c("multiselect", {
                            attrs: {
                              ...
                              [
                                _c("div", { staticClass: "form-group" }, [
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(_vm.__("till_which_status")) +
                                          " "
                                      ),
                                    ]
                                  ),
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("option", { attrs: { value: "" } }, [
                                        _vm._v(
                                          _vm._s(_vm.__("select_order_statue"))
                                        ),
                                      ]),
                                      _vm._v(" "),
                                      _vm._l(
                      ...
                      _c("div", { staticClass: "row" }, [
                        ...
                        _c("div", { staticClass: "col-md-4" }, [
                          _c(
                            ...
                            [
                              _c("label", [
                                _vm._v(
                                  _vm._s(_vm.__("tax_included_in_prices")) + " "
                                ),
                              ]),
                              _c("br"),
                              _vm._v(" "),
                              _c("b-form-radio-group", {
                                ...
                                model: {
                                  value: _vm.tax_included_in_price,
                                  callback: function ($$v) {
                                    _vm.tax_included_in_price = $$v
                                  },
                                  expression: "tax_included_in_price",
                                },
                              }),
                            ],
                            1
                        ...
                        _c("div", { staticClass: "col-md-4" }, [
                          _c("div", { staticClass: "form-group" }, [
                            ...
                            _c("span", { staticClass: "text text-primary" }, [
                              _vm._v(
                                _vm._s(_vm.__("keep_blank_if_no_such_limit"))
                              ),
                            ]),
                          ]),
                        ]),
                      ...
                      [
                        this.$roleSeller == _vm.login_user.role.name
                          ...
                          : [
                              _c("div", { staticClass: "form-group" }, [
                                _c("label", { staticClass: "control-label" }, [
                                  _vm._v(_vm._s(_vm.__("product_status"))),
                                ]),
                                _c("br"),
                                _vm._v(" "),
                                _c(
