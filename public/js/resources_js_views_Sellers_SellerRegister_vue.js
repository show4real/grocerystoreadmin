  ...
  methods: {
    registerSeller: function registerSeller() {
      ...
      if (this.$v.$invalid) {
        ...
        setTimeout(function () {
          var url = _this.$apiUrl + '/seller/register';
          axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, _this.seller).then(function (res) {
            vm.isLoading = false;
            var data = res.data;
            ...
            [
              _c(
                ...
                [
                    ...
                    directives: [
                      {
                        ...
                        value: _vm.$v.seller.username.$model,
                        expression: "$v.seller.username.$model",
                        modifiers: { trim: true },
                      },
                    ],
                    staticClass: "form-control form-control-xl",
                    attrs: { type: "text", placeholder: "Username" },
                    domProps: { value: _vm.$v.seller.username.$model },
                    on: {
                  ...
                  _vm._m(0),
                  _vm._v(" "),
                  _vm.$v.seller.username.$error
                    ? [
                        !_vm.$v.seller.username.required
              ...
              _c(
                ...
                [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model.trim",
                        value: _vm.$v.seller.store_name.$model,
                        expression: "$v.seller.store_name.$model",
                        modifiers: { trim: true },
                      },
                    ],
                    staticClass: "form-control form-control-xl",
                    attrs: { type: "text", placeholder: "Store Name" },
                    domProps: { value: _vm.$v.seller.store_name.$model },
                    on: {
                      input: function ($event) {
                        if ($event.target.composing) {
                          return
                  ...
                  _vm._m(1),
                  _vm._v(" "),
                  _vm.$v.seller.store_name.$error
                    ? [
                        !_vm.$v.seller.store_name.required
                          ? _c("span", { staticClass: "text-danger" }, [
                              _vm._v("Store Name is required"),
                            ])
                          : _vm._e(),
                      ]
                    : _vm._e(),
              ...
              _c(
                ...
                [
                  ...
                  _vm._m(2),
                  _vm._v(" "),
                  _vm.$v.seller.email.$error
                    ? [
                        !_vm.$v.seller.email.required
                          ? _c("span", { staticClass: "text-danger" }, [
                              _vm._v("Email is required"),
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        !_vm.$v.seller.email.email
                          ? _c("span", { staticClass: "text-danger" }, [
              ...
              _c(
                ...
                [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model.trim",
                        value: _vm.$v.seller.mobile.$model,
                        expression: "$v.seller.mobile.$model",
                        modifiers: { trim: true },
                      },
                    ],
                    staticClass: "form-control form-control-xl",
                    attrs: { type: "text", placeholder: "Mobile" },
                    domProps: { value: _vm.$v.seller.mobile.$model },
                    on: {
                      input: function ($event) {
                        if ($event.target.composing) {
                          return
                  ...
                  _vm._m(3),
                  _vm._v(" "),
                  _vm.$v.seller.mobile.$error
                    ? [
                        !_vm.$v.seller.mobile.required
                          ? _c("span", { staticClass: "text-danger" }, [
                              _vm._v("Mobile number is required"),
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        !_vm.$v.seller.mobile.numeric
                          ? _c("span", { staticClass: "text-danger" }, [
              ...
              _c(
                ...
                [
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model.trim",
                        value: _vm.$v.seller.password.$model,
                        expression: "$v.seller.password.$model",
                        modifiers: { trim: true },
                      },
                    ],
                    staticClass: "form-control form-control-xl",
                    ...
                    domProps: { value: _vm.$v.seller.password.$model },
                    on: {
                      input: function ($event) {
                        if ($event.target.composing) {
                          return
                  ...
                  _vm._v(" "),
                  _vm.$v.seller.password.$error
                    ? [
                        !_vm.$v.seller.password.required
                          ? _c("span", { staticClass: "text-danger" }, [
                              _vm._v("Password is required"),
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        !_vm.$v.seller.password.minLength
                          ? _c("span", { staticClass: "text-danger" }, [
                              _vm._v(
                                "Password must have at least " +
                                  _vm._s(
                                    _vm.$v.seller.password.$params.minLength.min
                                  ) +
                                  " letters."
                              ),
                            ])
              ...
              _c(
                ...
                [
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model.trim",
                        value: _vm.$v.seller.password_confirmation.$model,
                        expression: "$v.seller.password_confirmation.$model",
                        modifiers: { trim: true },
                      },
                    ],
                    staticClass: "form-control form-control-xl",
                    ...
                    on: {
                      input: function ($event) {
                        ...
                        _vm.$set(
                          _vm.$v.seller.password_confirmation,
                          "$model",
                          $event.target.value.trim()
                        )
                      },
                  ...
                  _vm._v(" "),
                  _vm.$v.seller.password_confirmation.$error
                    ? [
                        !_vm.$v.seller.password_confirmation.sameAsPassword
                          ? _c("span", { staticClass: "text-danger" }, [
