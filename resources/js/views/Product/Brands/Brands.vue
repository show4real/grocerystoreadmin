...
<!--                            <table class="table mt-10">
                                ...
                                <tbody>
                                    <tr v-for="(brand,index) of brands">
                                        <td>{{ brand.id }}</td>
                                        <td>{{ brand.name }}</td>
                                        <td>
                                            <label class="btn btn-success btn-sm" v-if="brand.status ==1">Active</label>
                                            <label class="btn btn-danger btn-sm" v-if="brand.status ==0">Deactivate</label>
                                        </td>
                                        <td>
                                            <button class="btn btn-secondary" @click="edit_record = brand">Edit</button>
                                            <button class="btn btn-danger" @click="deleteRecord(index,brand.id)">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>-->
