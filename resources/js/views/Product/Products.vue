...
<!--                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-primary btn_refresh" v-b-tooltip.hover :title="__('refresh')" @click="getRecords()">
...
<!--                                        <b-button class="btn btn-warning" v-b-tooltip.hover title="Filter" v-b-toggle.sidebar-right v-if="this.$currentWidth < this.$mobileWidth" ><i class="fa fa-filter"></i></b-button>-->
                                    </div>
                                        ...
                                        <div style="width: 120px">
                                            ...
                                            <template v-if="$roleSeller == login_user.role.name">
                                                <router-link
                                                    ...
                                                    v-b-tooltip.hover title="View" class="btn btn-primary btn-sm" v-b-tooltip.hover :title="__('view')" >
                                                    <i class="fa fa-eye"></i>
                                                </router-link>
                                                <router-link
                                                    :to="{ name: 'SellerEditProduct',params: { id: row.item.id, record : row.item }}"
                                                    v-b-tooltip.hover title="Edit" class="btn btn-success btn-sm"
    ...
    data: function () {
        return {
            ...
            fields: [
                ...
                {key: 'product_variant_id', label: __('id'), visible: false, sortable: true, sortDirection: 'desc'},
                {key: 'product_id', label: __('product_id'), visible: false, sortable: true, sortDirection: 'desc'},
                ...
                {key: 'indicator', label: __('indicator'), visible: true, class: 'text-center', sortable: true},
                {key: 'is_approved', label: __('is_approved'), visible: true, class: 'text-center', sortable: true},
                {key: 'return_status', label: __('return'), visible: true, class: 'text-center', sortable: true},
                {key: 'cancelable_status', label: __('cancellation'), visible: true, class: 'text-center', sortable: true},
                {key: 'till_status', label: __('till_status'), visible: true, class: 'text-center', sortable: true},
