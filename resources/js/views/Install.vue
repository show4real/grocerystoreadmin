                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" placeholder="Admin Email" v-model="database.admin_email" id="admin_email" class="form-control" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="password" placeholder="Admin Password" v-model="database.admin_password" id="admin_password" class="form-control" required autocomplete="off" />
                                            </div>
                                        </div>
    ...
    methods: {
        getRequirements: function () {
            ...
            axios.get(this.$apiUrl + '/install/requirements').then((response) => {
                ...
                console.log("requirements =>", this.statuses);
