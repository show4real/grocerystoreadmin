...
<!--                                        <template #head(total)="row">
                                        ...
                                        <template #cell(actions)="row">
                                            <router-link :to="{ name: 'DeliveryBoyOrder',params: { id: row.item.id, record : row.item }}" v-b-tooltip.hover title="View" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></router-link>
                                        </template>
                                    </b-table>
                                </div>
                                <b-row>
