            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Wishlists List</h3>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><router-link to="/dashboard">{{ __('dashboard') }}</router-link></li>
                                <li class="breadcrumb-item active" aria-current="page">Wishlists List</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(actions)="row">
                                    <router-link to="manage_products" class="btn btn-sm btn-primary" v-b-tooltip.hover :title="__('view')">
    ...
    data: function() {
        return {
            fields: [
                ...
                { key: 'total_qty', label: 'Quantity', sortable: true, class: 'text-center' },
                { key: 'seller_name', label: 'Seller', sortable: true, class: 'text-center' },
