            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Delivery boy Privacy Policy And Terms & Conditions</h3>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><router-link to="/dashboard">Dashboard</router-link></li>
                                <li class="breadcrumb-item active" aria-current="page">Delivery boy Privacy Policy And Terms & Conditions</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<!--                                <ckeditor :editor="editor" v-model="policies.privacy_policy_delivery_boy" :config="editorConfig"></ckeditor>-->
                                <editor
...
<!--                                <ckeditor :editor="editor" v-model="policies.terms_conditions_delivery_boy" :config="editorConfig"></ckeditor>-->
                                <editor
