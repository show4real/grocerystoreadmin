...
<!--                                <ckeditor :editor="editor" v-model="policies.privacy_policy_manager_app" :config="editorConfig"></ckeditor>-->
                                <editor
...
<!--                                <ckeditor :editor="editor" v-model="policies.terms_conditions_manager_app" :config="editorConfig"></ckeditor>-->
                                <editor
