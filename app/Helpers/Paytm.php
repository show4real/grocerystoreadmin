...
class Paytm
{
    ...
    {
        $paytm_payment_mode = Setting::get_value('paytm_mode');
        $paytm_merchant_key = Setting::get_value('paytm_merchant_key');
        $paytm_merchant_id = Setting::get_value('paytm_merchant_id');
        $paytm_website = Setting::get_value('paytm_website');
        //$paytm_industry_type_id = Setting::get_value('paytm_industry_type_id');
        $paytm_industry_type_id = "Retail";

        $data['paytm_payment_mode'] = $paytm_payment_mode??"sandbox";
        $data['paytm_merchant_key'] = $paytm_merchant_key;
        $data['paytm_merchant_id'] = $paytm_merchant_id;
        $data['url'] = ($paytm_payment_mode == "production") ? "https://securegw.paytm.in/" : "https://securegw-stage.paytm.in/";
        $data['paytm_website'] = ($paytm_payment_mode == "production") ? $paytm_website : "WEBSTAGING";
        $data['paytm_industry_type_id'] = ($paytm_payment_mode == "production") ? $paytm_industry_type_id : "Retail";
        return $data;
    }
    ...
    static public function transaction_status($order_id)
    {
        ...
        curl_close($ch);
        if (isset($error_msg)) {
            Log::info("curl paytm transaction_status error message : ",[$error_msg]);
        }

        Log::info("curl paytm transaction_status response : ",[$response]);
